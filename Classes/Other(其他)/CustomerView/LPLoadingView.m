...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        for (int i = 0; i < horizontalImageNames.count; i++) {
            [horizontalImages addObject:[UIImage oddityImage:[horizontalImageNames objectAtIndex:i]]];
        }
        ...
        for (int i = 0; i < verticalImageNames.count; i++) {
            [verticalImages addObject:[UIImage oddityImage:[verticalImageNames objectAtIndex:i]]];
        }
