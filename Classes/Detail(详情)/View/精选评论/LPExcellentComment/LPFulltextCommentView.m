...
- (void)setFulltextCommentArray:(NSArray *)commentsArray {
    ...
    for (int i = 0; i < commentsArray.count; i ++) {
        ...
        [iconImageView sd_setImageWithURL:[NSURL URLWithString:comment.userIcon] placeholderImage:[UIImage oddityImage:@"评论用户占位图"]];
        ...
        CGFloat textH = [[comment commentAttributeString] heightWithConstraintWidth:textW];
        ...
        if (comment.isPraiseFlag.boolValue) {
            [upButton setBackgroundImage:[UIImage oddityImage:@"点赞心1"] forState:UIControlStateNormal];
        } else {
            [upButton setBackgroundImage:[UIImage oddityImage:@"点赞心0"] forState:UIControlStateNormal];
        }
