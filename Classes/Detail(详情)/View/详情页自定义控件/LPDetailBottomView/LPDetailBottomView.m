...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [shareBtn setBackgroundImage:[UIImage oddityImage:@"详情页分享"]  forState:UIControlStateNormal];
        ...
        [favoriteBtn setBackgroundImage:[UIImage oddityImage:@"详情页未收藏"] forState:UIControlStateNormal];
        ...
        [noCommentsBtn setBackgroundImage:[UIImage oddityImage:@"详情页未评论"] forState:UIControlStateNormal];
        ...
        [commentsBtn setBackgroundImage:[UIImage oddityImage:@"详情页已评论"] forState:UIControlStateNormal];
        ...
        [contentBtn setBackgroundImage:[UIImage oddityImage:@"详情页原文"] forState:UIControlStateNormal];
