...
- (void)setupScrollView {
    ...
    //---------------------- 评论列表 ---------------------
    CGFloat commentsTableViewH = ScreenHeight - (StatusBarHeight + TabBarHeight + 0.5) ;
...
- (void)didClickCommentsWithDetailBottomView:(LPDetailBottomView *)detailBottomView {
    ...
    [self.backBtn setBackgroundImage:[UIImage oddityImage:@"详情页返回"] forState:UIControlStateNormal];
    [self.shareButton setBackgroundImage:[UIImage oddityImage:@"详情页右上分享"] forState:UIControlStateNormal];
}
...
- (void)didClickContentsWithDetailBottomView:(LPDetailBottomView *)detailBottomView {
    ...
    frame.origin.y = 0;
    [self.scrollView scrollRectToVisible:frame animated:YES];
    [self.backBtn setBackgroundImage:[UIImage oddityImage:@"video_back"] forState:UIControlStateNormal];
    [self.shareButton setBackgroundImage:[UIImage oddityImage:@"video_share_white"] forState:UIControlStateNormal];
}
