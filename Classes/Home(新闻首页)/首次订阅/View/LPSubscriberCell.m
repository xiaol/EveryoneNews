...
//        
        ...
        [subcriberButton setBackgroundImage:[UIImage oddityImage:@"订阅号加号"] forState:UIControlStateNormal];
...
- (void)setSubscriberFrame:(LPSubscriberFrame *)subscriberFrame {
    ...
    self.subscriberImageView.image = [UIImage oddityImage:subscriber.imageURL];
...
- (void)subcriberButtonDidClick {
    ...
    if (self.buttonSelected) {
        [self.subcriberButton setBackgroundImage:[UIImage oddityImage:@"订阅号对勾"] forState:UIControlStateNormal];
    } else {
        [self.subcriberButton setBackgroundImage:[UIImage oddityImage:@"订阅号加号"] forState:UIControlStateNormal];
    }
