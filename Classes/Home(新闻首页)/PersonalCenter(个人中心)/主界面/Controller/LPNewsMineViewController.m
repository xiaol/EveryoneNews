...
- (void)setupViews{
    ...
    if (account) {
        [iconImageView sd_setImageWithURL:[NSURL URLWithString:account.userIcon] placeholderImage:[UIImage oddityImage:@"home_user"]];
    ...
    [bookButton setBackgroundImage:[UIImage oddityImage:@"个人中心一订"] forState:UIControlStateNormal];
    ...
    [settingButton setBackgroundImage:[UIImage oddityImage:@"个人中心设置"] forState:UIControlStateNormal];
