...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [deleteButton setBackgroundImage:[UIImage oddityImage:@"我的评论删除按钮"] forState:UIControlStateNormal];
        ...
        [upButton setBackgroundImage:[UIImage oddityImage:@"我的评论未点赞"] forState:UIControlStateNormal];
        ...
        spreadImageView.image = [UIImage oddityImage:@"我的评论展开"];
