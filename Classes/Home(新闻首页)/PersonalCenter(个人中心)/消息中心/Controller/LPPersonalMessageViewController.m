//
//  LPPersonalMessageViewController.m
//  EveryoneNews
//
...
@interface LPPersonalMessageViewController ()

@end

@implementation LPPersonalMessageViewController
...
- (void)viewDidLoad{
    ...
    noMessageImageView.image = [UIImage oddityImage:@"wuxiaoxi"];
    ...
    noticeLabel.textColor = [UIColor colorFromHexString:LPColor5];
