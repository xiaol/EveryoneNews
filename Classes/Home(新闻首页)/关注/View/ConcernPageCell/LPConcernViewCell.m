...
- (void)setCardFrame:(LPCardConcernFrame *)cardFrame {
    ...
    if ([card.rtype integerValue] == videoNewsType) {
        ...
        if(card.cardImages.count == 0) {
            ...
            [self.firstMutipleImageView sd_setImageWithURL:[NSURL URLWithString:firstImageURL] placeholderImage:[UIImage oddityImage:@"单图小图占位图"]];
            [self.secondMutipleImageView sd_setImageWithURL:[NSURL URLWithString:secondImageURL] placeholderImage:[UIImage oddityImage:@"单图小图占位图"]];
            [self.thirdMutipleImageView sd_setImageWithURL:[NSURL URLWithString:thirdImageURL] placeholderImage:[UIImage oddityImage:@"单图小图占位图"]];
