//
//  LPweiboViewController.m
//  EveryoneNews
//
//  Created by dongdan on 16/9/8.
...
- (void)setupSubViews {
    ...
    [closeButton setBackgroundImage:[UIImage oddityImage:@"loginClose"] forState:UIControlStateNormal];
    ...
    [weixinButton setBackgroundImage:[UIImage oddityImage:@"loginWeChat"] forState:UIControlStateNormal];
    ...
    [weiboButton setBackgroundImage:[UIImage oddityImage:@"loginSina"] forState:UIControlStateNormal];
    ...
    [self.view addGestureRecognizer:removeKeyboardRecognizer];
}
