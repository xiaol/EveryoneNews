...
- (void)setupView {
    ...
    if (self.searchHistoryArray.count > 0) {
        searchHistoryBackgroundView.frame = CGRectMake(0, 0, ScreenWidth, 180);
    } else {
    ...
    searchHistoryLabel.font = [UIFont systemFontOfSize:14];
    ...
    CGFloat searchHistoryCollectionViewHeight = 180 - 50.5;
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
    ...
    if(self.searchItemsFrames.count == 0) {
        ...
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"头条百家字"]];
...
- (void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText {
    ...
    if([searchText isEqualToString:@""] || searchText == nil) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            self.searchHistoryBackgroundView.frame = CGRectMake(0, 0, ScreenWidth, 180);
            CGFloat hotWordCollectionViewHeight = ScreenHeight - 20 - TabBarHeight - 180;
            
            self.hotWordBackgroundView.frame = CGRectMake(0, 180, ScreenWidth, hotWordCollectionViewHeight);
            self.hotWordCollectionView.frame = CGRectMake(0, 30.5 , ScreenWidth, self.hotWordBackgroundView.frame.size.height - 30.5);
