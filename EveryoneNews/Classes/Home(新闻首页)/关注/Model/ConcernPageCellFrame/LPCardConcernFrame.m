...
- (void)setCard:(Card *)card {
    ...
    if ([card.rtype integerValue] == videoNewsType) {
        ...
        CGFloat singleTitleH = singleLineRect.size.height + lineSpacing;
        ...
        _videoImageKeywordFrame = CGRectMake(keywordX, keywordY, keywordW, keywordH);
        CGFloat imageY = CGRectGetMaxY(_videoImageKeywordFrame) + paddingTop;
        ...
        _videoImageSourceListViewFrame = CGRectMake(sourceListViewX, sourceListViewY, sourceListViewW, sourceListViewH);
        ...
        // 来源
        CGFloat sourceSiteNameX = CGRectGetMaxX(_videoImageKeywordFrame) + 7;
        ...
        _videoSourceLabelFrame = CGRectMake(sourceSiteNameX, sourceSiteNameY, sourceSiteNameW, sourceSiteNameH);
        
        // 分割线
        CGFloat videoImageSeperatorLineY = 0.0f;
        
        if (titleH > imageH) {
            videoImageSeperatorLineY = CGRectGetMaxY(_videoTitleLabelFrame) + keywordPaddingTop;
        } else {
            videoImageSeperatorLineY = CGRectGetMaxY(_videoImageViewFrame) + keywordPaddingTop;
        }
