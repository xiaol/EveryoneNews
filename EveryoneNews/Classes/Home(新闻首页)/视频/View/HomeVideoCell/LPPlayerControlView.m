...
- (instancetype)init {
    if (self = [super init]) {
        ...
        topImageView.image = [UIImage imageNamed:@"video_top_shadow"];
        ...
        [shareButton setImage:[UIImage imageNamed:@"video_share_white"] forState:UIControlStateNormal];
        ...
        [lockScreenButton setImage:[UIImage imageNamed:@"video_unlock"] forState:UIControlStateNormal];
        [lockScreenButton setImage:[UIImage imageNamed:@"video_lock"] forState:UIControlStateSelected];
        ...
        bottomImageView.image = [UIImage imageNamed:@"video_bottom_shadow"];
        [self addSubview:bottomImageView];
        self.bottomImageView = bottomImageView;
        
        // 音量
        UIButton *volumnButton = [[UIButton alloc] init];
        [volumnButton setImage:[UIImage imageNamed:@"video_volume"] forState:UIControlStateNormal];
        [volumnButton setImage:[UIImage imageNamed:@"video_mute"] forState:UIControlStateSelected];
        ...
        [videoSlider setThumbImage:[UIImage imageNamed:@"video_huakuai"] forState:UIControlStateNormal];
        ...
        [fullScreenButton setImage:[UIImage imageNamed:@"video_max"] forState:UIControlStateNormal];
        [fullScreenButton setImage:[UIImage imageNamed:@"video_mini"] forState:UIControlStateSelected];
...
- (void)lp_playerModel:(LPPlayerModel *)playerModel {
    ...
    if (playerModel.placeHolderImageURLString) {
        ...
        [self.placeholderImageView sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"video_loading_bgView"]];
    } else {
