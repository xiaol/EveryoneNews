...
@interface LPSpecialTopicViewCell()
...
@implementation LPSpecialTopicViewCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    self.backgroundColor = [UIColor colorFromHexString:@"#f6f6f6"];
    UIColor *fontColor = [UIColor colorFromHexString:@"#1a1a1a"];
    ...
    if(self) {
        ...
        noImageLabel.textColor = fontColor;
        ...
        multipleImageLabel.textColor = fontColor;
...
- (void)setCardFrame:(LPSpecailTopicCardFrame *)cardFrame {
     CGFloat lineSpacing = 2.0;
    _cardFrame = cardFrame;
    LPSpecialTopicCard *card = _cardFrame.card;
    ...
    NSAttributedString *attributeTitle =  [card.title truncatingTailAttributedStringWithFont:[UIFont systemFontOfSize:cardFrame.homeViewFontSize] lineSpacing:lineSpacing];
