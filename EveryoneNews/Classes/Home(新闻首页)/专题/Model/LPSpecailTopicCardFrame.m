...
@implementation LPSpecailTopicCardFrame

- (void)setCard:(LPSpecialTopicCard *)card {
    ...
    if(card.cardImages.count == 0) {
        ...
        if ((titleH + sourceSiteNameH + sourcePaddingTop1 ) > imageH) {
            ...
            titleY = (imageH - (titleH + sourceSiteNameH + paddingVertical)) / 2  + paddingVertical;
        }
