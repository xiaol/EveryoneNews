...
- (void)setComment:(LPComment *)comment
{
    ...
    CGFloat textX = nameX;
    CGFloat textY = CGRectGetMaxY(_timeLabelF) + 10;
    CGFloat textW = ScreenWidth - textX  - iconPaddingLeft;
    
    _attributeCommentText = [comment commentAttributeString];
    CGFloat textH = [_attributeCommentText heightWithConstraintWidth:textW];
    
    _commentLabelF = CGRectMake(textX, textY, textW, textH);
    
    CGFloat upButtonW = 18.0f;
    CGFloat upButtonH = 18.0f;
    ...
    _cellHeight =  iconPaddingTop * 2  + nameH + timeH + textH + 10;
}
